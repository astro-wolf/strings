 ...
 * "L" will always make it move left, etc. Also, assume that the magnitude of the robot's movement is the
 * same for each move.
 *
 * Example 1:
 * Input: "UD"
...
public class RobotMoves {
    ...
    public static void main(String[] args) {
        ...
        boolean returnsToOrigin = robotMoves.judgeCircle("LURDRDLUU");
        System.out.print(returnsToOrigin);
    }
